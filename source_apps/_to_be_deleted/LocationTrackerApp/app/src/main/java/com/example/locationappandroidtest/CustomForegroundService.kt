...
class CustomForegroundService : Service() {
    ...
    private val periodicTask = object : Runnable {
        override fun run() {
            ...
            logger.log("LOCATION", lastUpdateTime)

            fusedLocationClient.lastLocation
                .addOnSuccessListener { location : Location? ->
                    // Log location or use as needed
                    location?.let {
                        logger.log("\tLOCATION2", "Current location: ${location.latitude}, ${location.longitude}")
                        ...
                        updateNotification(
                            ...
                            "Not doing much at the moment (Last update sent: $lastUpdateTime) Current location: ${location.latitude}, ${location.longitude}\""
                        )
                    }
                }
