...
std::wostream& operator<<(std::wostream& os, const WindowInfo& window_info) {
    ...
    std::wcout << L"PID: " << window_info.processId << std::endl;
    std::wcout << L"Title: " << window_info.title << std::endl;
    std::wcout << L"Executable Name: " << window_info.exe_name << std::endl;
    std::wcout << L"Class Name: " << window_info.class_name << std::endl;
    std::wcout << L"Dimensions: " << L"Top: " << window_info.dimensions.top << L", Left: " << window_info.dimensions.left << L", Bottom: " << window_info.dimensions.bottom << L", Right: " << window_info.dimensions.right << std::endl;
    std::wcout << L"State: " << (window_info.is_minimised ? L"Minimized" : L"Normal/Maximized") << std::endl;
    std::wcout << L"Memory usage: " << window_info.memory_usage << std::endl;
    std::wcout << L"Module Name: " << window_info.module_name << std::endl;
    std::wcout << "-------------------------------------" << std::endl;
